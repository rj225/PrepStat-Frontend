  ...
  return (
    <footer className="text-gray-700 font-serif body-font bg-gradient-to-br from-[#ffffff] via-[#ffd195] via-60% to-[#ffffff] ">
      <div className="container md:px-5 py-3 mx-auto flex justify-center items-center flex-col">
        ...
        <p className="text-sm flex justify-center text-gray-600 ml-3 pl-3 md:ml-4 md:pl-4 py-2 mt-0">    
          &copy; {new Date().getFullYear()} All rights reserved.
        </p>
        </div>
        <p className="mt-2 italic font-medium text-gray-700 font-serif">Designed with ❤️ by the PrepStat Team.</p>
      </div>
    </footer>
  );
}
