...
const MainContent = () => {
  ...
  return (
    <div className="min-h-screen font-serif">
      <Helmet>
        <title>PrepStat - Placement Preparation Platform</title>
        <meta
          name="description"
          content="PrepStat is your all-in-one platform for placement preparation. Covering aptitude, reasoning, verbal, and interview questions."
        />
        <meta
          name="keywords"
          content="placement preparation, aptitude test,Prepstat,PrepStat,prepstat, reasoning questions, verbal ability, interview questions, coding practice, campus recruitment, placement preparation platform, placement exam preparation, job placement preparation, technical interview preparation"
        />
        <meta
          property="og:title"
          content="PrepStat - Placement Preparation Platform"
        />
        <meta
          property="og:description"
          content="PrepStat is your all-in-one platform for placement preparation."
        />
        <meta
          property="og:image"
          content="URL of the image you want to display"
        />
        <link rel="canonical" href="https://www.prepstat.in/" />
      </Helmet>
      ...
      <div className="flex max-w-screen min-h-screen flex-row">
        ...
        <div className="flex-1 w-8/12 overflow-hidden md:overflow-visible md:w-full h-full">
          ...
          <section
            id="Feature"
            className="container bg-gradient-to-tl from-[#f8f3ed] from-20% via-[#f7e8d3] to-[#f8e1c4] mx-auto py-16"
          >
              ...
              <div className="flex items-center" data-aos="zoom-in">
                <table className="w-full text-left md:text-lg text-sm bg-white overflow-hidden shadow-lg rounded-lg">
                  ...
                  <tbody className="divide-y divide-orange-400">
                    ...
                    <tr>
                      <td className="md:px-6 px-2 md:py-4 py-1">
                        Interview Prep
                      </td>
                      <td className="md:px-6 md:text-base text-xs px-2 md:py-4 py-2">
          ...
          <section className="bg-gradient-to-tl from-[#f8f3ed] from-20% via-[#f7e8d3] to-[#f8e1c4] flex w-full items-center justify-center py-16">
            <div
              className="md:p-10 p-3 mx-auto text-center"
              data-aos="zoom-out"
            >
              ...
              <ul className="list-disc list-outside text-left md:text-lg pl-10 text-base text-gray-700 space-y-4">
                <li>
                  <span className="text-orange-700">Comprehensive</span>{" "}
                  coverage of placement topics.
                </li>
                <li>
                  Tailored <span className="text-orange-700">quizzes</span> and{" "}
                  <span className="text-orange-700">mock tests</span>.
                </li>
                <li>
                  Data-driven insights for{" "}
                  <span className="text-orange-700">smarter</span> preparation.
                </li>
                <li>
                  Guidance from industry{" "}
                  <span className="text-orange-700">professionals</span>.
                </li>
                <li>
                  <span className="text-orange-700">Regular</span> updates to
                  stay industry-relevant.
                </li>
              </ul>
            </div>
            <div
              className=" md:w-1/2 w-full md:block hidden rounded-2xl"
              data-aos="flip-right"
            >
              <img
                src={img}
                alt="Illustration showing placement preparation process"
                className="h-80 md:block hidden border-r-8 border-t-8 border-orange-500 w-auto shadow-lg rounded-2xl"
              />
            </div>
          </section>
          ...
          {/* testimonial */}
          <section
            id="testimonial_section_img"
            className="max-w-screen-xl relative overflow-hidden"
          >
            <div className="">
              <Testimonial />
            </div>
